        ...
        <div className="w-full bg-[url('https://htmldemo.net/zymzoo/zymzoo/assets/img/photos/bg-f1.png')] py-10 px-4 lg:px-40 lg:py-30">
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10 max-w-7xl mx-auto">
            <div className="lg:w-1/2 text-center lg:text-left">
              <div className="mb-4">
                <h1 className="lg:text-6xl text-3xl font-bold mb-4 text-white lg:leading-20 leading-18">The My Fitness Club Blog</h1>
            ...
            <div className="lg:w-1/2 backdrop-blur-2xl backdrop-blur-lg bg-[#D4D4D4] p-6 rounded-md ">
              ...
              />
              <button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br font-medium rounded-lg text-1xl px-5 py-2.5 text-center me-2 mt-3  cursor-pointer"
              onClick={hnadleSenBtn}
              >Send</button>
            </div>
          </div>
        </div>z
